...
const SmallScreenSideNav: React.FC<SmallScreenProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="pt-6 px-5 relative">
      <div className="sm:hidden mt-1 mb-8 ">
      ...
      >
        ...
        <form onSubmit={handleSignOut}>
          <button
            type="submit"
            className="flex h-[48px] w-1/2  grow items-center  rounded-md mt-10 border border-white ml-8 p-3 text-sm font-medium  justify-start "
            disabled={loading}
          >
            {loading ? (
              <DotPulseWrapper
