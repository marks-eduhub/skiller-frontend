  ...
  return (
    <>
      ...
      <div className="hidden md:relative md:col-span-2 md:h-[20px] md:flex md:justify-center md:self-center">
        {data2.currentIndex === 0 && <Image src={data.slider1} alt={"slider icon"} priority={true} fill />}
        {data2.currentIndex === 1 && <Image src={data.slider} alt={"slider icon"} priority={true} fill />}
