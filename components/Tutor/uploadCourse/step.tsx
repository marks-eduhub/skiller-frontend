...
const Step: React.FC<TopicProps> = ({ name, deleteTopic }) => {
    ...
    <div className="border border-gray-200 p-6 flex flex-col gap-3">
      {expanded && (
        <div>
          ...
          <div>
            <div className="mt-20">
              <h1>Upload Video</h1>
              <div className="flex flex-col mt-5 items-center justify-center border border-dashed border-black p-3 relative h-[200px] rounded"  onChange={handleImageChange}>
      ...
      <div className="w-full h-[100px] bg-gray-300  cursor-pointer">
        ...
        >
          ...
          <h1 className="font-semibold text-[18px]">Add your topics</h1>
        </div>
      </div>
      <CustomModal
        isOpen={isModalOpen}
